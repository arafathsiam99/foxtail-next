  ...
  return (
    <div className={`styles.container dark:bg-slate-700`}>
      ...
      <div>
        ...
        <h1 className="text-fuchsia-600 text-3xl md:text-5xl font-medium tracking-wide  md:ml-14 ml-5 my-3 md:my-5  dark:text-white">
          Top Creators
        </h1>
        ...
        <h1 className="text-fuchsia-600 text-3xl md:text-5xl font-medium tracking-wide  md:ml-14 ml-5 py-3 dark:text-white">
          Latest
        </h1>
        <div>
          <div className="grid md:grid-cols-3 md:px-10 mx-3">
